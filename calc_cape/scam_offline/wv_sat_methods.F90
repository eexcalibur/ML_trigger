...
real(r8) :: tmelt = 273.15   ! Melting point of water at 1 atm (K)
real(r8) :: h2otrip = 273.16 ! Triple point temperature of water (K)
real(r8) :: tboil = 373.16   ! Boiling point of water at 1 atm (K)

real(r8) ::  ttrice = 20.0  ! Ice-water transition range

real(r8) :: epsilo = 0.621970586204516  ! Ice-water transition range
real(r8) :: omeps = 0.378029413795484  ! 1._r8 - epsilo
