program cape_calc
    ...
    do i=1,ntimeobs
       ...
       call buoyan_dilute_1(1   ,1    , &
                    ...
                    rgas    ,grav    ,cpres   ,msg     , &
                    tpert   )
        capeOBS(i) = (cape(1) - capeOBS(i)) / 1.0 ! sgp
        !capeOBS(i) = (cape(1) - capeOBS(i)) / 3.0 ! goamazon

     end do
     !open(1001, file="goamazon_dcape.txt")
!     open(1001, file="entrainment/goamazon_dilute_dcape_dmpdz_0.25.txt")
!     open(1001, file="entrainment/goamazon_dilute_dcape_dmpdz_0.5.txt")
!     open(1001, file="entrainment/goamazon_dilute_dcape_dmpdz_0.75.txt")
     open(1001, file="entrainment/goamazon_dilute_dcape_dmpdz_1.0.txt")
!     open(1001, file="entrainment/goamazon_dilute_dcape_dmpdz_1.25.txt")
!     open(1001, file="entrainment/goamazon_dilute_dcape_dmpdz_1.5.txt")
!     open(1001, file="entrainment/goamazon_dilute_dcape_dmpdz_1.75.txt")
!     open(1001, file="entrainment/goamazon_dilute_dcape_dmpdz_2.0.txt")
!     open(1001, file="entrainment/goamazon_dilute_dcape_dmpdz_2.25.txt")
!     open(1001, file="entrainment/goamazon_dilute_dcape_dmpdz_2.5.txt")
!     open(1001, file="entrainment/goamazon_dilute_dcape_dmpdz_2.75.txt")
!     open(1001, file="entrainment/goamazon_dilute_dcape_dmpdz_3.0.txt")
!     open(1001, file="entrainment/goamazon_dilute_dcape_dmpdz_3.25.txt")
!     open(1001, file="entrainment/goamazon_dilute_dcape_dmpdz_3.5.txt")
!     open(1001, file="entrainment/goamazon_dilute_dcape_dmpdz_3.75.txt")
!     open(1001, file="entrainment/goamazon_dilute_dcape_dmpdz_4.0.txt")
!     open(1001, file="entrainment/goamazon_dilute_dcape_dmpdz_4.25.txt")
!     open(1001, file="entrainment/goamazon_dilute_dcape_dmpdz_4.5.txt")
!     open(1001, file="entrainment/goamazon_dilute_dcape_dmpdz_4.75.txt")
!     open(1001, file="entrainment/goamazon_dilute_dcape_dmpdz_5.0.txt")
